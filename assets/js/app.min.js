! function(t) {
    ...
    i.prototype.initTooltipPlugin = function() {
        ...
        t(this).attr("data-delay") && t(this).attr("data-delay"), t(this).attr("data-time") && t(this).attr("data-time");
        t('[data-plugin="counterup"]').each(function(i, e) {
            t(this).counterUp({
                delay: 100,
                time: 1200
            })
    ...
    }, i.prototype.initTippyTooltips = function() {
        t('[data-plugin="tippy"]').length > 0 && tippy('[data-plugin="tippy"]')
...
function(t) {
    ...
    i.prototype._resetSidebarScroll = function() {
        ...
        t(".button-menu-mobile").on("click", function(t) {
            t.preventDefault(), i.$body.toggleClass("sidebar-enable"), i.$window.width() >= 768 ? i.$body.toggleClass("enlarged") : i.$body.removeClass("enlarged"), i._resetSidebarScroll()
            ...
            t(i.target).closest(".right-bar-toggle, .right-bar").length > 0 || t(i.target).closest(".left-side-menu, .side-nav").length > 0 || t(i.target).hasClass("button-menu-mobile") || t(i.target).closest(".button-menu-mobile").length > 0 || (t("body").removeClass("right-bar-enabled"), t("body").removeClass("sidebar-enable"))
        }), t("#side-menu a").each(function() {
            var i = window.location.href.split(/[?#]/)[0];
            this.href == i && (t(this).addClass("active"), t(this).parent().addClass("active"), t(this).parent().parent().addClass("in"), t(this).parent().parent().prev().addClass("active"), t(this).parent().parent().parent().addClass("active"), t(this).parent().parent().parent().parent().addClass("in"), t(this).parent().parent().parent().parent().parent().addClass("active"))
